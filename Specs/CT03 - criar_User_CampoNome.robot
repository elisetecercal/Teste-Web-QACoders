...
Realizar Login e Cadastrar novo Usuario com apenas Nome
    ...
    Input Text     ${CadastrosUsuario.NomeCompletoUsuario}  ${PreencheFormularioUsuario['Nome']}
    ...
    Element Should Contain    ${MensagemErroNomeCompleto.msgNomeCompleto}   Informe o nome e sobrenome com as iniciais em letra maiúscula e sem caracteres especiais.
    ...
    Log To Console    "O sistema corretamente impediu o cadastro de um Nome Completo não composto por duas palavras."
